...
| USER |   账号,仅支持手机号|
| PWD |   密码|
| STEP_DAY |   上午步数:0则为1w-2w之间随机,自定义随机范围: `6000-8000`|
| STEP_NOON |   中午步数:0则为1w-2w之间随机,自定义随机范围: `10000-12000`|
| STEP_AFTER |   下午步数:0则为1w-2w之间随机,自定义随机范围: `14000-16000`|
| STEP_NIGHT |   晚上步数:0则为1w-2w之间随机,自定义随机范围: `18000-23000`|
